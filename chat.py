...
if api_key:
    ...
    raise ValueError("Google API Key not found. Please ensure the .env file is set up properly.")
...
def get_vector_store(text_chunks):
    ...
    if not os.path.exists("faiss_index"):
        ...
        st.warning("Vector store already exists. Loading the existing store.")
